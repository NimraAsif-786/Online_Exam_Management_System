<%@ Page Language="C#" MasterPageFile ="~/Stud.Master" AutoEventWireup="true" CodeBehind="StudMCQ.aspx.cs" Inherits="VPLab7.StudMCQ" %>
   ...
   <div class ="container">
      ...
      <asp:Label ID="lblsid" runat="server" Text="Enter your ID:"></asp:Label>
       ...
       <div class="form-group">
            ...
            <asp:TextBox ID="txtopt1" runat="server" class="form-control" BackColor="#E6E6E6" ReadOnly="true"></asp:TextBox>
       ...
       <div class="form-group">
            ...
            <asp:TextBox ID="txtopt2" runat="server" class="form-control" BackColor="#E6E6E6"  ReadOnly="true"></asp:TextBox>
     
         </div>
        
         <div class="form-group">

         <asp:Label ID="labelopt3" runat="server" Text="Option C:"></asp:Label>

       <asp:TextBox ID="txtopt3" runat="server" class="form-control" BackColor="#E6E6E6" ReadOnly="true"></asp:TextBox>
