...
namespace VPLab7
{
	public partial class StudShortQ : System.Web.UI.Page
	{
		...
		protected void btnStart_Click(object sender, EventArgs e)
		{
			...
			{
				Short S = new Short();
				S.Exid = examid;    // Use the class-level variable
				ShortBLL obj = new ShortBLL();


				DataTable dt = obj.studshSelectBLL(S);
		...
		protected void btnCalculateResult_Click(object sender, EventArgs e)
		{
			...
			if (int.TryParse(hiddenExamID.Value, out examid))
			{
				...
				S.Sid = int.Parse(txtsid.Text);
				S.Tmarks = totalMarks;
				S.Obmarks = obtainScore;

				if (obj.resshInsertBLL(S))
				{
