<%@ Page Language="C#"  MasterPageFile ="~/Instruct.Master"  AutoEventWireup="true" CodeBehind="MCQ.aspx.cs" Inherits="VPLab7.MCQ" %>
...
<asp:Content ID ="Content1" ContentPlaceHolderID ="MainContent" runat="server">
   ...
   <div class ="container">
    ...
    <asp:Button ID="btnView" runat="server" Text="ViewAll" CssClass =" btn-crud" OnClick="btnView_Click"/>
       ...
       <asp:TextBox ID="txtopt3" runat="server" class="form-control"></asp:TextBox>
